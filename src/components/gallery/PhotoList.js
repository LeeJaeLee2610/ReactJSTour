...
const PhotoItem = ({ info: { url, isFavourite, id } }) => {
  ...
  return (
    <div className="relative h-[300px] cursor-pointer group">
      ...
      <span
        className="absolute z-10 cursor-pointer right-5 top-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all"
      ...
      <button
        className="py-2 px-6 absolute p-4 text-black bg-white rounded-lg -translate-x-2/4 bottom-5 left-2/4 text-sm font-medium 
